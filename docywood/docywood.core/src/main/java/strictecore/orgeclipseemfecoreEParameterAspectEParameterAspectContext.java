...
public class orgeclipseemfecoreEParameterAspectEParameterAspectContext {
  ...
  private Map<EParameter, orgeclipseemfecoreEParameterAspectEParameterAspectProperties> map = new java.util.WeakHashMap<org.eclipse.emf.ecore.EParameter, strictecore.orgeclipseemfecoreEParameterAspectEParameterAspectProperties>();
