...
public class orgeclipseemfecoreETypedElementAspectETypedElementAspectContext {
  ...
  private Map<ETypedElement, orgeclipseemfecoreETypedElementAspectETypedElementAspectProperties> map = new java.util.WeakHashMap<org.eclipse.emf.ecore.ETypedElement, strictecore.orgeclipseemfecoreETypedElementAspectETypedElementAspectProperties>();
