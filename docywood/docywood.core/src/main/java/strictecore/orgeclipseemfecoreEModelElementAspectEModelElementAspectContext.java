...
public class orgeclipseemfecoreEModelElementAspectEModelElementAspectContext {
  ...
  private Map<EModelElement, orgeclipseemfecoreEModelElementAspectEModelElementAspectProperties> map = new java.util.WeakHashMap<org.eclipse.emf.ecore.EModelElement, strictecore.orgeclipseemfecoreEModelElementAspectEModelElementAspectProperties>();
