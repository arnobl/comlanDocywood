...
public class orgeclipseemfecoreEAnnotationAspectEAnnotationAspectContext {
  ...
  private Map<EAnnotation, orgeclipseemfecoreEAnnotationAspectEAnnotationAspectProperties> map = new java.util.WeakHashMap<org.eclipse.emf.ecore.EAnnotation, strictecore.orgeclipseemfecoreEAnnotationAspectEAnnotationAspectProperties>();
