...
public class orgeclipseemfecoreEClassifierAspectEClassifierAspectContext {
  ...
  private Map<EClassifier, orgeclipseemfecoreEClassifierAspectEClassifierAspectProperties> map = new java.util.WeakHashMap<org.eclipse.emf.ecore.EClassifier, strictecore.orgeclipseemfecoreEClassifierAspectEClassifierAspectProperties>();
