...
public class orgeclipseemfecoreEEnumLiteralAspectEEnumLiteralAspectContext {
  ...
  private Map<EEnumLiteral, orgeclipseemfecoreEEnumLiteralAspectEEnumLiteralAspectProperties> map = new java.util.WeakHashMap<org.eclipse.emf.ecore.EEnumLiteral, strictecore.orgeclipseemfecoreEEnumLiteralAspectEEnumLiteralAspectProperties>();
