...
public class orgeclipseemfecoreEGenericTypeAspectEGenericTypeAspectContext {
  ...
  private Map<EGenericType, orgeclipseemfecoreEGenericTypeAspectEGenericTypeAspectProperties> map = new java.util.WeakHashMap<org.eclipse.emf.ecore.EGenericType, strictecore.orgeclipseemfecoreEGenericTypeAspectEGenericTypeAspectProperties>();
