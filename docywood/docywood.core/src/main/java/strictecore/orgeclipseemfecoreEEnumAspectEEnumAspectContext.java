...
public class orgeclipseemfecoreEEnumAspectEEnumAspectContext {
  ...
  private Map<EEnum, orgeclipseemfecoreEEnumAspectEEnumAspectProperties> map = new java.util.WeakHashMap<org.eclipse.emf.ecore.EEnum, strictecore.orgeclipseemfecoreEEnumAspectEEnumAspectProperties>();
