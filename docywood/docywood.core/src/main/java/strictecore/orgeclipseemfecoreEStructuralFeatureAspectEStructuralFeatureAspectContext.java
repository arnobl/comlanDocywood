...
public class orgeclipseemfecoreEStructuralFeatureAspectEStructuralFeatureAspectContext {
  ...
  private Map<EStructuralFeature, orgeclipseemfecoreEStructuralFeatureAspectEStructuralFeatureAspectProperties> map = new java.util.WeakHashMap<org.eclipse.emf.ecore.EStructuralFeature, strictecore.orgeclipseemfecoreEStructuralFeatureAspectEStructuralFeatureAspectProperties>();
