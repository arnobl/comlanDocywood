...
public class orgeclipseemfecoreENamedElementAspectENamedElementAspectContext {
  ...
  private Map<ENamedElement, orgeclipseemfecoreENamedElementAspectENamedElementAspectProperties> map = new java.util.WeakHashMap<org.eclipse.emf.ecore.ENamedElement, strictecore.orgeclipseemfecoreENamedElementAspectENamedElementAspectProperties>();
