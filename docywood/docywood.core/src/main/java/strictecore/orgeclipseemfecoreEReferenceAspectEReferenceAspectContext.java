...
public class orgeclipseemfecoreEReferenceAspectEReferenceAspectContext {
  ...
  private Map<EReference, orgeclipseemfecoreEReferenceAspectEReferenceAspectProperties> map = new java.util.WeakHashMap<org.eclipse.emf.ecore.EReference, strictecore.orgeclipseemfecoreEReferenceAspectEReferenceAspectProperties>();
