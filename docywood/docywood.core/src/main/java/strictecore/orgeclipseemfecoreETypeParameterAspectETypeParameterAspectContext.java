...
public class orgeclipseemfecoreETypeParameterAspectETypeParameterAspectContext {
  ...
  private Map<ETypeParameter, orgeclipseemfecoreETypeParameterAspectETypeParameterAspectProperties> map = new java.util.WeakHashMap<org.eclipse.emf.ecore.ETypeParameter, strictecore.orgeclipseemfecoreETypeParameterAspectETypeParameterAspectProperties>();
