...
public class orgeclipseemfecoreEClassAspectEClassAspectContext {
  ...
  private Map<EClass, orgeclipseemfecoreEClassAspectEClassAspectProperties> map = new java.util.WeakHashMap<org.eclipse.emf.ecore.EClass, strictecore.orgeclipseemfecoreEClassAspectEClassAspectProperties>();
